...
export default function CardPaymentForm({
  ...
  const handleCardNumberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (formatted.length <= 19) {
      ...
      setValidation((prev) => ({
        ...prev,
        number: validateCardNumber(formatted),
      }))
  ...
  const getValidationIcon = (
    state: "incomplete" | "complete" | "invalid"
  ) => {
    if (state === "complete")
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="flex items-center space-x-2">
              <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" />
              <span className="text-sm">
                Unlimited posting to all social media accounts
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" />
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2">
                  {getValidationIcon(validation.expiry)}
                </div>
              </div>
              <p
                className={`text-xs ${
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                />
                <div className="absolute right-3 top-1/2 -translate-y-1/2">
                  {getValidationIcon(validation.cvc)}
                </div>
              </div>
              <p
                className={`text-xs ${
          ...
          <div className="space-y-4">
            ...
            <div className="text-xs text-gray-500 text-center px-4">
              By clicking "Pay $15/month", you'll start your Premium plan
              subscription of $15/month, with a renewal date of the same date
              each month.
            </div>
          </div>
        </CardContent>
